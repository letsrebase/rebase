...
const CODERABBIT_LOOP_LINES = [
  ...
  "```",
  "",
  "The summary is edited in place on every round, so it is read only once it names",
  "this sha; a missing `crid` after that means the round raised nothing, not that",
...
const ADVERSARIAL_LOOP_LINES = [
  ...
  "before going on. What each finding gets is in (d) below, not here: the one",
  "mistake to avoid is replying on Greptile's own thread before CodeRabbit's",
  "adversarial verdict has landed.",
  "",
